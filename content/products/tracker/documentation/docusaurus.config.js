...
module.exports = {
    plugins: [
        ...
        [
            ...
            {
                id: "tracker-reference-rest",
                docsPluginId: "classic",
                config: {
                    tracker: {
                        specPath: "https://raw.githubusercontent.com/animeapis/openapi-specification/master/animeshon/tracker/v1alpha1/openapi.yaml",
                        outputDir: "content/products/tracker/documentation/docs/reference/rest/v1alpha1",
                        sidebarOptions: {
                            groupPathsBy: "tag",
